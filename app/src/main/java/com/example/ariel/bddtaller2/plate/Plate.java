...
import com.example.ariel.bddtaller2.category.CategoryDao;
...
public class Plate {
    ...
    @Generated(hash = 1507620658)
    private transient PlateDao myDao;
    @Generated(hash = 1698894820)
    public Plate(Long Id, String name, long categoryId) {
        this.Id = Id;
        this.name = name;
        this.categoryId = categoryId;
    }
    @Generated(hash = 2007101467)
    public Plate() {
    }
    public Long getId() {
        return this.Id;
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 1484039555)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getPlateDao() : null;
    }
}
